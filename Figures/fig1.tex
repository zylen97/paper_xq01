...
% === Mediation note box (H6a–H6f) ===
\node[draw, rounded corners=4pt, fill=gray!3,
      text width=12.5cm, align=center, font=\scriptsize,
      inner sep=5pt]
     at (5.5, -6.5) {%
  \textbf{Mediation hypotheses (H6a--H6f):}\\[3pt]
  H6a: WU$\rightarrow$SM$\rightarrow$IC\quad\quad
  H6b: WU$\rightarrow$RM$\rightarrow$IC\quad\quad
  H6c: WU$\rightarrow$PM$\rightarrow$IC\\[2pt]
  H6d: SU$\rightarrow$SM$\rightarrow$IC\quad\quad
  H6e: SU$\rightarrow$RM$\rightarrow$IC\quad\quad
  H6f: SU$\rightarrow$PM$\rightarrow$IC
};
